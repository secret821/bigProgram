...
可以根据商品id或者分类进行页面跳转，1：商品 2：分类
     *
     * @return index_type - 轮播图类型 轮播图类型，用于判断，
...
可以根据商品id或者分类进行页面跳转，1：商品 2：分类
     *
     * @param indexType 轮播图类型 轮播图类型，用于判断，
...
可以根据商品id或者分类进行页面跳转，1：商品 2：分类
    ...
    /**
     * 获取是否展示:1表示正常显示，0表示下线 是否

展示，1：展示    0：不展示
     *
     * @return status - 是否展示:1表示正常显示，0表示下线 是否
...
展示，1：展示    0：不展示
    ...
    /**
     * 设置是否展示:1表示正常显示，0表示下线 是否

展示，1：展示    0：不展示
     *
     * @param status 是否展示:1表示正常显示，0表示下线 是否
