...
否）
     *
     * @return is_anonymous - 是否匿名（1:是，0:
...
差评）
     *
     * @return comm_type - 评价类型（1好评，0中评，-1
...
已回复）
     *
     * @return reply_status - 是否回复（0:未回复，1:
...
已回复）
     *
     * @param replyStatus 是否回复（0:未回复，1:
