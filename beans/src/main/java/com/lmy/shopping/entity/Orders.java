...
2-退款关闭 4-买家取消 15-已通过货到付款交易
    ...
    /**
     * 获取订单状态 1:待付款 2:待发货 3:待收货 4:待评价 5:已完成 

6:已关闭
     *
     * @return status - 订单状态 1:待付款 2:待发货 3:待收货 4:待评价 5:已完成 
...
6:已关闭
    ...
    /**
     * 设置订单状态 1:待付款 2:待发货 3:待收货 4:待评价 5:已完成 

6:已关闭
     *
     * @param status 订单状态 1:待付款 2:待发货 3:待收货 4:待评价 5:已完成 
...
删除
     *
     * @return delete_status - 逻辑删除状态 1: 删除 0:未
...
删除
     *
     * @param deleteStatus 逻辑删除状态 1: 删除 0:未
...
2-退款关闭 4-买家取消 15-已通过货到付款交易
     *
     * @return close_type - 订单关闭类型1-超时未支付 
